      ...
      <div id="ftth-left">
        ...
        <div id="ftth-form-area">
          ...
          <div id="ftth-welcome">
            ...
            <p>You need to change your password to activate your account or satisfy security requirements.</p>
          </div>
          ...
          <div id="ftth-card">
            ...
            <form id="kc-passwd-update-form" action="${url.loginAction}" method="post">
              ...
              <!-- Submit button -->
              <input tabindex="3" id="kc-login" name="login" type="submit" value="${msg("doSubmit")}"/>
