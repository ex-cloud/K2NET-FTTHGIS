            ...
            <div class="ftth-card-header">
              <div class="ftth-card-header-left">
                <div class="ftth-card-header-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#f87171" stroke-width="2">
                    <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
                  </svg>
                </div>
                <div class="ftth-card-header-text">
                  <span class="ftth-card-title">${orgName}</span>
                  <span class="ftth-card-subtitle" style="color:#f87171;">Authentication Sequence Error</span>
                </div>
              </div>
