...
<@layout.registrationLayout displayMessage=!((messagesPerField.existsError('totp'))!false) displayInfo=true; section>
    <#if section = "header">
        ${msg("doLogIn")}
    <#elseif section = "form">
      ...
      <div id="ftth-left" style="min-height:100vh;overflow-y:auto;background:#09090b;display:flex;flex-direction:column;justify-content:space-between;position:relative;border-right:1px solid rgba(0,0,0,0.95);box-shadow:1px 0 0 0 rgba(255,255,255,0.065);z-index:10;">
        ...
        <div id="ftth-form-area" style="width:100%;max-width:390px;margin:auto;padding:12px 0;z-index:20;">
          ...
          <div class="ftth-card">
            ...
            <div class="ftth-card-header">
              <div class="ftth-card-header-left">
                ...
                <div class="ftth-card-header-text">
                  ...
                  <span class="ftth-card-subtitle">Two-Factor Authentication Security</span>
                </div>
              </div>
            ...
            <#if (messagesPerField.existsError('totp'))!false>
            ...
            <form id="kc-otp-login-form" action="${url.loginAction}" method="post">
              ...
              <#if (otpLogin.userOtpCredentials?size)!0 gt 1>
                <div class="form-group" style="margin-bottom:12px;">
                  <label for="kc-otp-credential-id" style="font-family:'JetBrains Mono',monospace;font-size:10px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#a1a1aa;margin-bottom:6px;display:block;">
                    ${msg("loginOtpDevice")}
                  </label>
                  <select id="kc-otp-credential-id" name="selectedCredentialId" style="width:100%;height:38px;border-radius:8px;background:rgba(9,9,11,0.6);border:1px solid rgba(63,63,70,0.6);color:#fff;padding:0 12px;font-size:13px;outline:none;">
              ...
              <div class="form-group" style="margin-bottom:16px;">
                <label for="otp" style="font-family:'JetBrains Mono',monospace;font-size:10px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#a1a1aa;margin-bottom:6px;display:block;">
                  ${msg("loginOtpOneTime")}
                </label>
                <input tabindex="1" id="otp" name="otp" autocomplete="one-time-code" type="text"
                  placeholder="••••••" inputmode="numeric" pattern="[0-9]*" maxlength="8"
                  style="width:100%;height:44px;border-radius:10px;border:1px solid rgba(34,197,94,0.4);background:rgba(9,9,11,0.8);padding:0 12px;font-size:22px;color:#22c55e;outline:none;text-align:center;letter-spacing:8px;font-weight:700;font-family:'JetBrains Mono',monospace;"
                  autofocus aria-invalid="<#if (messagesPerField.existsError('totp'))!false>true</#if>">
              </div>
          ...
          <div id="ftth-security-notice" style="border-radius:12px;border:1px solid rgba(34,197,94,0.25);background:rgba(34,197,94,0.05);padding:10px 12px;display:flex;gap:10px;align-items:flex-start;margin-top:12px;">
            ...
            <span style="font-size:11px;color:#a1a1aa;line-height:1.4;">
              Otentikasi multifaktor wajib ditegakkan untuk menjaga keamanan akun dan isolasi multi-tenant K2NET.
            </span>
          </div>
