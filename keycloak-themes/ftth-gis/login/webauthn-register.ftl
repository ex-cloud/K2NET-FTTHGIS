...
<@layout.registrationLayout displayInfo=true displayMessage=true; section>
    ...
    <!-- ============================================================
         FTTH GIS — Split-Screen Passkey / WebAuthn Registration
         ============================================================ -->
    <div class="ftth-login-container" style="display:flex;min-height:100vh;width:100%;font-family:'Inter',sans-serif;">
      ...
      <div id="ftth-left">
        ...
        <div id="ftth-form-area">
          ...
          <!-- Welcome text -->
          <div id="ftth-welcome">
            <h1>Register Security Key / Passkey</h1>
            <p>Enroll your biometric sensor or hardware token (YubiKey).</p>
          </div>
          ...
          <div id="ftth-card">
            ...
            <div style="text-align:center;padding:16px 0;">
              <div style="width:72px;height:72px;border-radius:50%;background:rgba(34,197,94,0.1);border:1px solid rgba(34,197,94,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;">
              ...
              <p style="font-size:13px;color:var(--zinc-300);line-height:1.6;margin-bottom:20px;">
                Click Register and follow the prompt from your browser to register your device.
              </p>
              ...
              <form id="register" action="${url.loginAction}" method="post">
                ...
                <button tabindex="1" class="ftth-btn-primary" type="button" id="registerWebAuthnButton" onclick="window.registerWebAuthn && window.registerWebAuthn()">
      ...
      <div id="ftth-right">
        ...
        <div id="ftth-quote-card">
          ...
          <p id="ftth-quote-text">
            &ldquo;Hardware security keys provide unphishable authentication and full cryptographic identity verification.&rdquo;
          </p>
