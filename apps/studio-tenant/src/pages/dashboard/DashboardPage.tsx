...
import { Badge, Button, PageHeader, PageContentShell, MetricCard } from "@k2net/ui";
...
export function DashboardPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden">
      ...
      <PageHeader
        title="Ringkasan Operasional Jaringan"
        badge={
      ...
      <PageContentShell maxWidth="7xl" className="space-y-6">
        {/* KPI Cards Grid using Shared MetricCard with Groove */}
