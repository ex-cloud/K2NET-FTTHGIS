...
function MinioDrainTestCard({
  handleTestDrain,
  isTestingEmail,
  smtpDrainResult,
}: {
  handleTestDrain: () => void;
  isTestingEmail: boolean;
  smtpDrainResult: { success: boolean; message: string } | null;
}) {
  return (
    ...
    <SystemSecurityWrapper>
      <PageLayout variant="workspace" spaceY="space-y-6">
        ...
        <div className="space-y-8 pb-16">
          ...
          <MinioDrainTestCard
            handleTestDrain={handleTestDrain}
            isTestingEmail={isTestingEmail}
            smtpDrainResult={smtpDrainResult}
          />
        </div>
      </PageLayout>
    </SystemSecurityWrapper>
