...
function PasswordComplexityToggles({
  ...
  setRequireSymbols: (v: boolean) => void;
...
function PasswordHistoryAndExpiry({
  historyLimit,
  setHistoryLimit,
  expiryDays,
  setExpiryDays,
...
function PasswordEvaluationMatrixCard({
  minLength,
  requireSymbols,
  requireNumbers,
  requireUppercase,
