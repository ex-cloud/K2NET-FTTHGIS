  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        ...
        className="w-full sm:max-w-[760px] p-0 flex flex-col bg-background border-l border-border overflow-hidden"
      >
        {/* ── Header bar ─────────────────────────────────────────────────── */}
        <div className="flex items-center justify-between px-5 py-3 border-b border-border/60 bg-card/30 shrink-0">
          ...
          <div className="flex items-center gap-1.5 shrink-0 pr-2">
            ...
            <SheetClose className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors" title="Close">
              <X className="h-4 w-4" />
            </SheetClose>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <div className="flex flex-col lg:flex-row min-h-full">
            ...
            <div className="w-full lg:w-72 shrink-0 border-t lg:border-t-0 lg:border-l border-border/40 px-4 py-5 space-y-0.5 bg-card/20">
