...
import { MapProviderStatusCard } from "@/components/gateways/map/MapProviderStatusCard";
import { z } from "zod";
...
export default function MapGatewayPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    const keysToUpdate = ["GOOGLE_MAPS_API_KEY", "HERE_MAPS_API_KEY"];
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                <MapCachePerformanceCard />
                <MapProviderStatusCard />
              </div>
            </div>
          )}
        </div>
