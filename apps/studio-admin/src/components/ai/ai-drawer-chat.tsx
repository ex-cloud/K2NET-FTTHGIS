...
function AiDrawerEmptyState({ greeting, pinnedIdeas, onSelectIdea }: EmptyStateProps) {
  return (
...
function AiDrawerInputArea({ input, isStreaming, onInputChange, onSend, onStop }: InputAreaProps) {
...
export function AiDrawerChat({
  messages, pinnedIdeas, input, onInputChange, onSend, onStop,
