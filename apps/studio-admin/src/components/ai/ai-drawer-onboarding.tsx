...
export function AiDrawerOnboarding({ onReviewPermissions }: AiDrawerOnboardingProps) {
  return (
    <div className="flex-1 flex items-start justify-center pt-8 px-4 overflow-y-auto">
      <div className="w-full max-w-sm bg-card border border-border rounded-lg shadow-sm overflow-hidden">
        {/* Icon + Heading */}
        <div className="pt-7 pb-4 flex flex-col items-center gap-3 bg-gradient-to-b from-primary/5 to-transparent">
          <div className="w-14 h-14 rounded-lg bg-gradient-to-tr from-primary/30 via-primary/15 to-amber-500/20 border border-primary/25 flex items-center justify-center shadow-xs">
        ...
        <div className="p-4 space-y-3">
          ...
          <button
            ...
            className="w-full h-8 rounded-md bg-primary text-primary-foreground text-xs font-medium hover:bg-primary/90 transition-colors cursor-pointer shadow-xs"
          >
            Review permissions
          </button>
        </div>
