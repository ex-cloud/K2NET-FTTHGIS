...
const nextConfig: NextConfig = {
  output: "standalone",
  reactCompiler: true,
  allowedDevOrigins: ["system.lvh.me", "localhost", "lvh.me", "system.gis.kdua.net", "system-gis.kdua.net", "gis.kdua.net", "system.gis.k2net.id", "system-gis.k2net.id", "gis.k2net.id"],
  async rewrites() {
    return [
      {
