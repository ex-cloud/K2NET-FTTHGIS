...
export function AdminSidebar() {
  ...
  const adminNavItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: Building2,
      href: "/organizations",
      isActive: pathname === "/organizations" || pathname === "/system/organizations",
    },
    {
      title: "Global Users",
      icon: Users,
      href: "/users",
      isActive: pathname === "/users" || pathname === "/system/users" || pathname?.startsWith("/users"),
    },
    {
      title: "System Health",
      icon: Activity,
      href: "/health",
      isActive: pathname === "/health" || pathname === "/system/health" || pathname?.startsWith("/health"),
    },
    {
      title: "Usage Metrics",
      icon: BarChart3,
    ...
    },
    {
      ...
      icon: Settings,
      href: "/settings",
      isActive: pathname === "/settings" || pathname === "/system/settings" || pathname?.startsWith("/settings"),
    },
  ];
