      ...
      <div className="w-full max-w-5xl mx-auto space-y-8 pb-20">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {/* Storage optimization Panel Column */}
            <div className="space-y-6">
              
              {/* Storage Space Saved Card */}
              <Card className="bg-[#0b0b0b]/40 border-white/5 shadow-xl">
                <CardHeader>
                  ...
                  <CardDescription className="text-[10px] text-zinc-500">
                    Layanan pemrosesan gambar mendeteksi tipe mime gambar secara otomatis, melakukan resizing dan kompresi ke format WebP.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-semibold text-emerald-400">68.5% Saved</span>
                    </div>
                    <Progress value={68.5} className="h-2 bg-zinc-900 border border-white/5" />
                  </div>

                  <div className="grid grid-cols-2 gap-4 text-xs pt-2">
                    <div>
                      <p className="text-[9px] text-zinc-500 uppercase tracking-wider font-bold">Total File Diproses</p>
                      <p className="text-sm font-semibold font-mono text-zinc-200 mt-0.5">24,561</p>
                    </div>
                    <div>
                      <p className="text-[9px] text-zinc-500 uppercase tracking-wider font-bold">Tingkat Kegagalan</p>
                      <p className="text-sm font-semibold font-mono text-emerald-400 mt-0.5">0.02%</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0b0b0b] border border-white/5 rounded-lg p-3.5 space-y-3">
                    <div className="flex justify-between text-xs border-b border-white/5 pb-2">
                      ...
                      <span className="font-mono text-zinc-300">124.6 GB</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-zinc-500 flex items-center gap-1.5"><Cpu className="w-3.5 h-3.5 text-emerald-500" /> Hasil WebP:</span>
                      <span className="font-mono text-emerald-400 font-bold">39.2 GB</span>
                    </div>
                  </div>
              ...
              <Card className="bg-[#0b0b0b]/40 border-white/5 shadow-xl">
                ...
                <CardContent className="space-y-3 text-xs">
                  <div className="flex items-center justify-between pb-2 border-b border-white/5">
                    <span className="text-zinc-400">Library Pemroses</span>
                    <Badge className="bg-zinc-900 text-zinc-300 border-white/5 text-[9px]">disintegration/imaging</Badge>
                  </div>
                  <div className="flex items-center justify-between pb-2 border-b border-white/5">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-zinc-400">Batas Ukuran Upload</span>
